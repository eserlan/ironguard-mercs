...
describe("LobbyService", () => {
    ...
    it("should allow solo launch if mercenary is selected and player is ready", () => {
        ...
        // Internal state manipulation or calling private methods via casting if needed
        // For unit testing solo launch, we can simulate the flow
