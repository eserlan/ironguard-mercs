...
export const VOID_STALKER: EnemyArchetype = {
	...
	breakThreshold: 60,
	visual: { rigType: "R15", profileKey: "Slasher", weaponKey: "VoidDagger" },
};
...
export const IRON_REAPER: EnemyArchetype = {
	...
	breakThreshold: 65,
	visual: { rigType: "R15", profileKey: "Slasher", weaponKey: "IronScythe" },
};
...
export const IRON_MEDIC: EnemyArchetype = {
	...
	breakThreshold: 50,
	visual: { rigType: "R15", profileKey: "Guard", weaponKey: "MedicStaff" },
};
...
export const VOID_ORACLE: EnemyArchetype = {
	...
	breakThreshold: 45,
	visual: { rigType: "R15", profileKey: "Guard", weaponKey: "VoidScepter" },
};
...
export const VOID_HAZARD: EnemyArchetype = {
	...
	breakThreshold: 150,
	visual: { rigType: "R15", profileKey: "Guard" },
};
