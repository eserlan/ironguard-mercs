...
export const VOID_BINDER: EnemyArchetype = {
	...
	breakThreshold: 80,
	visual: { rigType: "R15", profileKey: "Guard", weaponKey: "VoidStaff" },
};
...
export const IRON_WARLOCK: EnemyArchetype = {
	...
	breakThreshold: 85,
	visual: { rigType: "R15", profileKey: "Guard", weaponKey: "IronGauntlet" },
};
...
export const IRON_SENTRY: EnemyArchetype = {
	...
	breakThreshold: 100,
	visual: { rigType: "R15", profileKey: "Guard", weaponKey: "IronRifle" },
};
...
export const VOID_HOWLER: EnemyArchetype = {
	...
	breakThreshold: 90,
	visual: { rigType: "R15", profileKey: "Slasher", weaponKey: "VoidOrb" },
};
...
export const VOID_BULWARK: EnemyArchetype = {
	...
	breakThreshold: 120,
	visual: { rigType: "R15", profileKey: "Guard", weaponKey: "VoidShield" },
};
